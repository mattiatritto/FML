...
min_samples_leaf = 5
max_depth = 4
# In comparison to the simple decision tree classifier, there is the number of estimators
n_estimators = 200
...
over another due to the feature values magnitude (it is a Gradient Descent consequence). In the case of random forests,
...
model = RandomForestClassifier(n_estimators=n_estimators, criterion=criterion, min_samples_leaf=min_samples_leaf, max_depth=max_depth, random_state=random_state)
