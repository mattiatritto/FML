...
path_dataset = '../datasets/houses.csv'
selected_features = ['GrLivArea', 'LotArea', 'GarageArea', 'FullBath']
...
model = LinearRegression(n_features=X_train.shape[1], n_steps=n_steps, learning_rate=learning_rate)
